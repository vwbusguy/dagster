...
In fact, a logger that prints JSON-formatted single-line messages like this to the console is already included in Dagster (<PyObject object="json_console_logger"/>). But let's look at how we might implement a simplified version of this logger.
