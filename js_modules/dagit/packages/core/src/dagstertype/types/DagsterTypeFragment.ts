...
export interface DagsterTypeFragment_metadataEntries_NullMetadataEntry {
...
export interface DagsterTypeFragment_innerTypes_metadataEntries_NullMetadataEntry {
  __typename: "NullMetadataEntry";
  label: string;
  description: string | null;
}
