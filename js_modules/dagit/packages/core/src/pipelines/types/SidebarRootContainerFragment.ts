...
export interface SidebarRootContainerFragment_PipelineSnapshot_metadataEntries_NullMetadataEntry {
...
export interface SidebarRootContainerFragment_PipelineSnapshot_metadataEntries_NotebookMetadataEntry {
