...
export interface GraphExplorerFragment_PipelineSnapshot_metadataEntries_NullMetadataEntry {
...
export interface GraphExplorerFragment_PipelineSnapshot_metadataEntries_NotebookMetadataEntry {
