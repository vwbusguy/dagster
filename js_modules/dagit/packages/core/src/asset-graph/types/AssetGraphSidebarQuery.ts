...
export interface AssetGraphSidebarQuery_pipelineSnapshotOrError_PipelineSnapshot_metadataEntries_NullMetadataEntry {
...
export interface AssetGraphSidebarQuery_pipelineSnapshotOrError_PipelineSnapshot_metadataEntries_NotebookMetadataEntry {
