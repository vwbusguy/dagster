...
export interface LatestMaterializationMetadataFragment_metadataEntries_NullMetadataEntry {
...
export interface LatestMaterializationMetadataFragment_metadataEntries_NotebookMetadataEntry {
