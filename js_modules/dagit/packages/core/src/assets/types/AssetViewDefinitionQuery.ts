...
export interface AssetViewDefinitionQuery_assetOrError_Asset_definition_partitionDefinition {
...
export interface AssetViewDefinitionQuery_assetOrError_Asset_definition_metadataEntries_NullMetadataEntry {
...
export interface AssetViewDefinitionQuery_assetOrError_Asset_definition_type_innerTypes_metadataEntries_NullMetadataEntry {
  __typename: "NullMetadataEntry";
  label: string;
  description: string | null;
}
