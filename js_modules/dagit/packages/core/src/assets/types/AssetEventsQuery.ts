...
export interface AssetEventsQuery_assetOrError_Asset_assetObservations_metadataEntries_NullMetadataEntry {
...
export interface AssetEventsQuery_assetOrError_Asset_assetObservations_metadataEntries_NotebookMetadataEntry {
...
export interface AssetEventsQuery_assetOrError_Asset_assetMaterializations_metadataEntries_NullMetadataEntry {
  __typename: "NullMetadataEntry";
  label: string;
  description: string | null;
}
...
export interface AssetEventsQuery_assetOrError_Asset_assetMaterializations_metadataEntries_NotebookMetadataEntry {
  __typename: "NotebookMetadataEntry";
  label: string;
  description: string | null;
  path: string;
