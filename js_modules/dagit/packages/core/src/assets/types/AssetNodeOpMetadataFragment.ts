...
export interface AssetNodeOpMetadataFragment_metadataEntries_NullMetadataEntry {
...
export interface AssetNodeOpMetadataFragment_metadataEntries_NotebookMetadataEntry {
...
export interface AssetNodeOpMetadataFragment_type_metadataEntries_NotebookMetadataEntry {
  __typename: "NotebookMetadataEntry";
  label: string;
  description: string | null;
  path: string;
...
export interface AssetNodeOpMetadataFragment_type_innerTypes_metadataEntries_NullMetadataEntry {
  __typename: "NullMetadataEntry";
  label: string;
  description: string | null;
}
...
export interface AssetNodeOpMetadataFragment_type_innerTypes_metadataEntries_NotebookMetadataEntry {
  __typename: "NotebookMetadataEntry";
  label: string;
  description: string | null;
  path: string;
