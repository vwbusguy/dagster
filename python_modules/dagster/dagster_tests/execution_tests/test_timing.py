...
def test_event_timing_before_yield():
    ...
    pipeline_def = JobDefinition(solid_defs=[before_yield_solid], name="test")
...
def test_event_timing_after_yield():
    ...
    pipeline_def = JobDefinition(solid_defs=[after_yield_solid], name="test")
    pipeline_result = execute_pipeline(pipeline_def)
...
def test_event_timing_direct_return():
    ...
    pipeline_def = JobDefinition(solid_defs=[direct_return_solid], name="test")
    pipeline_result = execute_pipeline(pipeline_def)
