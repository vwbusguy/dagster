...
if is_papermill_2():
    ...
    class DagstermillEngine(NBClientEngine):  # pyright: ignore
        @classmethod
    ...
    from papermill.engines import NBConvertEngine  # pyright: ignore
    from papermill.preprocess import PapermillExecutePreprocessor  # pyright: ignore
