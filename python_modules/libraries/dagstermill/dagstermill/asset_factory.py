...
def define_dagstermill_asset(
    ...
    if op_tags is not None:
        check.invariant(
            ...
            "user-defined op tags contains the `notebook_path` key, but the `notebook_path` key is"
            " reserved for use by Dagster",  # noqa: E501
        )
        check.invariant(
            "kind" not in op_tags,
            "user-defined op tags contains the `kind` key, but the `kind` key is reserved for use"
            " by Dagster",
        )
