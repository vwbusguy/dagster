        ...
        if job_image:
            if job_image_from_executor_config:
                ...
                self._instance.report_engine_event(
                    ...
                    f" executor configuration, but also {job_image} in your user-code deployment."
                    f" Using the job image {job_image_from_executor_config} from executor"
                    " configuration as it takes precedence.",
                    run,
                    cls=self.__class__,
                )
        else:
